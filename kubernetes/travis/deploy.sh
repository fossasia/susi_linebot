...
openssl aes-256-cbc -K $encrypted_d337030e8f28_key -iv $encrypted_d337030e8f28_iv -in ./kubernetes/travis/susi-telegrambot-85cf0ec296e9.json.enc -out susi-telegrambot-85cf0ec296e9.json -d
mkdir -p lib
...
docker tag fossasia/susi_linebot:$TRAVIS_COMMIT fossasia/susi_linebot:latest-$DEPLOY_BRANCH
echo ">>> Pushing docker image"
docker push fossasia/susi_linebot
echo ">>> Updating deployment"
kubectl set image deployment/line --namespace=line line=fossasia/susi_linebot:$TRAVIS_COMMIT
